...
// À partir deste ponto, O ambiente rodará com 03 aplicações
...
public class MultiAppv3 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			createFogDevices(broker1.getId(), appId1, broker2.getId(), appId2, broker3.getId(), appId3);
			...
			controller.submitApplication(application3, 0,
					new MyModulePlacement(fogDevices, sensors, actuators, application3, moduleMapping3, "moduleB_3"));
	...
	private static void createFogDevices(int userId, String appId, int userId2, String appId2, int userId3, String appId3) {
		MyFogDevice cloud = createFogDevice("cloud", 44800, 40000, 100, 10000, 0, 0.01, 16 * 103, 16 * 83.25);
		cloud.setParentId(-1);
		fogDevices.add(cloud);
		deviceById.put(cloud.getId(), cloud);
	...
	private static void addGw(String gwPartialName, int userId, String appId, int userId2, String appId2, int userId3, String appId3,
			int parentId) {
		MyFogDevice gw = createFogDevice("g-" + gwPartialName, 2800, 4000, 10000, 10000, 1, 0.0, 107.339, 83.4333);
		fogDevices.add(gw);
		deviceById.put(gw.getId(), gw);
	...
	private static MyFogDevice addEnd(String endPartialName, int userId, String appId, int userId2, String appId2, int userId3, String appId3,
			int parentId) {
		MyFogDevice end = createFogDevice("e-" + endPartialName, 13200, 1000, 10000, 270, 2, 0, 87.53, 82.44);
		end.setParentId(parentId);
		idOfEndDevices.add(end.getId());
	...
	private static MyApplication createApplication0(String appId, int userId) {
		...
		application.addTupleMapping("moduleB_1", "ProcessedData-1_1", "ProcessedData-2_1", new FractionalSelectivity(0.9));
		application.addTupleMapping("moduleC_1", "ProcessedData-2_1", "ProcessedData-3_1", new FractionalSelectivity(1.0));
		application.addTupleMapping("moduleD_1", "ProcessedData-3_1", "ProcessedData-4_1", new FractionalSelectivity(1.0));
	...
	private static MyApplication createApplication1(String appId, int userId) {
		...
		application.addTupleMapping("moduleB_2", "ProcessedData-1_2", "ProcessedData-2_2", new FractionalSelectivity(0.9));
		application.addTupleMapping("moduleC_2", "ProcessedData-2_2", "ProcessedData-3_2", new FractionalSelectivity(1.0));
		application.addTupleMapping("moduleD_2", "ProcessedData-3_2", "ProcessedData-4_2", new FractionalSelectivity(1.0));
	...
	private static MyApplication createApplication2(String appId, int userId) {
		...
		application.addTupleMapping("moduleB_3", "ProcessedData-1_3", "ProcessedData-2_3", new FractionalSelectivity(0.9));
		application.addTupleMapping("moduleC_3", "ProcessedData-2_3", "ProcessedData-3_3", new FractionalSelectivity(1.0));
		application.addTupleMapping("moduleD_3", "ProcessedData-3_3", "ProcessedData-4_3", new FractionalSelectivity(1.0));

...
public class TestApplicationHearthCareIoT {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// Aqui o módulo principal é enviado para o ambient de execução para ser distribuído entre os fog nodes
	...
	private static void createEdgeDevices0(int userId, String appId) {
		for (FogDevice mobile : mobiles) {
			...
			MySensor eegSensor = new MySensor("s-" + appId + "-" + id, "EEG", userId, appId,
			...
			MyActuator display = new MyActuator("a-" + appId + "-" + id, userId, appId, "DISPLAY");

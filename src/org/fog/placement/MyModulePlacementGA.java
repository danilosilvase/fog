...
public class MyModulePlacementGA extends MyPlacement{
	...
	public MyModulePlacementGA(List<MyFogDevice> fogDevices, List<MySensor> sensors, List<MyActuator> actuators, 

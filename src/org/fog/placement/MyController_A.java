...
public class MyController_A extends SimEntity{
	...
	private Map<String, MyModulePlacementBF> appModulePlacementPolicy;
	
	public MyController_A(String name, List<MyFogDevice> fogDevices, List<MySensor> sensors, List<MyActuator> actuators) {
		super(name);
		this.applications = new HashMap<String, MyApplication>();
		setAppLaunchDelays(new HashMap<String, Integer>());
		setAppModulePlacementPolicy(new HashMap<String, MyModulePlacementBF>());
	...
	public void submitApplication(MyApplication application, int delay, MyModulePlacementBF modulePlacement){
	...
	public void submitApplication(MyApplication application, MyModulePlacementBF modulePlacement){
	...
	private void processAppSubmit(MyApplication application){
		...
		MyModulePlacementBF modulePlacement = getAppModulePlacementPolicy().get(application.getAppId());
		for(MyFogDevice fogDevice : fogDevices){
	...
	public Map<String, MyModulePlacementBF> getAppModulePlacementPolicy() {
		return appModulePlacementPolicy;
	}

	public void setAppModulePlacementPolicy(Map<String, MyModulePlacementBF> appModulePlacementPolicy) {
